...
public class TaskGroupContainer extends AbstractContainer {
    ...
    public void start() {
        try {
            ...
            this.containerCommunicator.registerCommunication(taskConfigs);   //taskId 与 task配置
            ...
            while (true) {
                ...
                while(iterator.hasNext() && runTasks.size() < channelNumber){
                	...
                	taskExecutor.doStart();  //启动任务 Task
    ...
    class TaskExecutor {
        ...
        public TaskExecutor(Configuration taskConf, int attemptCount) {
             ...
             */
            /**
             * 根据配置构建不同的Transformer ,注意：这里的Transformation相当于 "ETL" 里面的 “T”
             */
        ...
        public void doStart() {
            this.writerThread.start();    //必须先启动写线程
            ...
            /**
             * 启动读线程，注意上一步已经初始化了Transformer了，所有这里启动的时候，Transformer也做了相应的操作
             */
